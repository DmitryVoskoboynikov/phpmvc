...
namespace Fonts
{
    ...
    class Proxy
    {
        ...
        public function sniff($agent)
        {
            ...
            $platform = "#(ipod|iphone|ipad|webs|android|win|mac|linux)#i";
            ...
            if (preg_match($browser, $agent, $browsers))
            {
                ...
                return array(
                    "browser" => (strtolower($browser[1]) == "version") ? strtolower($browser[3]) : strtolower($browser[1]),
                    "version" => (float) (strtolower($browser[1]) == "opera") ? strtolower($browser[4]) : strtolower($browser[2]),
