...
namespace Framework
{
    ...
    class Request extends Base
    {
        ...
        protected function _setOptions($key, $value)
        {
        ...
        {
            return "CURLOPT_" . str_replace("CURLOPT_", "", strtopper($key));
        }
        ...
        protected function _setRequestMethod($method)
        {
            ...
            {
                case "HEAD":
                    $this->_setOptions(CURLOPT_NOBODY, true);
                    break;
                case "GET":
                    $this->_setOption(CURLOPT_HTTPGET, true);
                    break;
                case "POST":
                    $this->_setOptions(CURLOPT_POST, true);
                    break;
                default:
                    $this->_setOptions(CURLOPT_CUSTOMREQUEST, $method);
                    break;
            }
        ...
        protected function _setRequestOptions($url, $parameters)
        {
            ...
            {
                $this->_setOptions(constant($this->_normalize($key)), $value);
            }
