...
namespace Framewor\Database
{
    ...
    class Query extends Base
    {
        ...
        protected function __getExceptionForImplementation($method)
        {
        ...
        protected function _buildSelect()
        {
            ...
            if (!empty($_order))
            {
                ...
                $order = "ORDERE BY {$_order} {$_direction}";
            }
        ...
        public function delete()
        {
            ...
            $result = $this->_connector->exceute($sql);
            
            if ($result == false)
            {
                throw new Exceptioin\Sql();
            }
